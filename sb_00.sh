...
REBOOT_URL="https://raw.githubusercontent.com/ocarmelo/sbox/main/reboot.sh"
...
index_url="https://github.com/ocarmelo/sbox/blob/main/index.html"
[ -f "${FILE_PATH}/index.html" ] || $COMMAND "${FILE_PATH}/index.html" "$index_url"
}

changge_ports() {
reading "将删除全部端口然后随机开放1个tcp端口和1个udp端口,确定继续吗?(直接回车即确认更换)【y/n】: " choice
